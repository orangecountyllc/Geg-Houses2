            ...
            return this.each(function()
            {
                ...
                setInterval(function ()
                {
                    ...
                    if( options.analog )
                    {
                        ...
                        // goes dark between 6pm and 6am
                        if ( ( nd.getHours() >= 6 ) && ( nd.getHours() < 18 ) ) {
                            $('#' + id + ' .jcgmt-hour').addClass("clock-am");
                        } else {
                            $('#' + id + ' .jcgmt-hour').addClass("clock-pm");
                            // $('#' + id + ' .jcgmt-hour').attr("src","/images/second.png");
                            // $('#' + id + ' .jcgmt-min').attr("src","/images/seconds.png");
                        }
