...
(function ($, Drupal) {
  console.log('%c  four-home.js - Line 6 -  upto 328 ', 'background: 	#FFB6C1; color: #bada55');
  $.fn.subNav = function (options) {
    ...
    function onScroll() {
      console.log('%c  four-home.js - Line 62  ', 'background: 	#00FFFF; color: #000000');
    ...
    function calculateOffsets() {
      console.log('%c  four-home.js - Line 134  ', 'background: 	#00FFFF; color: #000000');
  ...
  $(document).ready(function () {
    ...
    if ($(window).width() <= 767) {
      // console.log('%c  four-home.js - Line 208  Window Width ', 'background: 	#00FFFF; color: #000000');
...
(function ($) {
  ...
  console.log('%c  four-home.js - Line 356   -  up to 458  ', 'background: 	#00FFFF; color: #000000');
...
(function ($) {
  ...
  // dev this is required for the bottom slider on home

  console.log('%c  four-home.js - Line 462 -  up to line 557  ', 'background: 	#00FFFF; color: #000000');
...
// Place your frontend scripts here
// Parallax Animaton variant 1 oct-24
(function ($) {
  $(window).scroll(function () {

    // where it change the color to purple. 
    ...
    for (var i = 0; i <= 9; i++) {
      ...
      if (eqPrallaxV1SecSlide.length) {
        ...
        // Height setup 
        var eqPrallaxV1SecSlideTop = eqPrallaxV1SecSlide.offset().top + 200; //300
